...
STRINGS = {
    "en": {
        ...
        "cmd_botpin_set": "\U0001F510 Bot PIN set. Admins must send it to sign in (other sessions were signed out).",
    ...
    "uk": {
        ...
        "cmd_botpin_set": "\U0001F510 PIN бота встановлено. Адміни мають надіслати його для входу (інші сесії завершено).",
